...
activate(ctx)/deactivate() contract so essentials_app.plugin.EssentialsAppPlugin
is already shaped correctly to drop in once Phase 1 ships — just delete this
